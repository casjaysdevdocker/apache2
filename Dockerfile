# Docker image for apache2 using the alpine template
ARG IMAGE_NAME="apache2"
ARG PHP_SERVER="apache2"
ARG BUILD_DATE="Sat Sep  2 02:16:46 PM EDT 2023"
...
ARG IMAGE_REPO="casjaysdevdocker/apache2"
...
ARG PACK_LIST="apache2 apache2-ctl apache2-lua apache2-ssl apache2-ldap apache2-icons apache2-http2 \
...
ENV HOSTNAME="casjaysdev-apache2"
...
LABEL \
  ...
  org.opencontainers.image.url="https://hub.docker.com/r/casjaysdevdocker/apache2" \
  org.opencontainers.image.url.source="https://hub.docker.com/r/casjaysdevdocker/apache2" \
  org.opencontainers.image.vcs-type="Git" \
  org.opencontainers.image.vcs-ref="${BUILD_VERSION}" \
  org.opencontainers.image.vcs-url="https://github.com/casjaysdevdocker/apache2" \
  org.opencontainers.image.documentation="https://github.com/casjaysdevdocker/apache2" \
